...
#define CUSTOM_LSM6DSL_0_SPI_Init BSP_SPI2_Init
#define CUSTOM_LSM6DSL_0_SPI_DeInit BSP_SPI2_DeInit
#define CUSTOM_LSM6DSL_0_SPI_Send BSP_SPI2_Send
#define CUSTOM_LSM6DSL_0_SPI_Recv BSP_SPI2_Recv

#define CUSTOM_LSM6DSL_0_CS_PORT GPIOB
#define CUSTOM_LSM6DSL_0_CS_PIN GPIO_PIN_0
